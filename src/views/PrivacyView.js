...
import { renderPrivacyContent } from '../components/info-modals.js';
...
export function PrivacyView({ router }) {
  ...
  const main = h('main', { className: 'flex-grow max-w-3xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-10 md:py-16' },
    ...
    h('h1', { className: 'font-headline text-3xl md:text-4xl font-extrabold text-onSurface mt-2 mb-6' }, '개인정보처리방침'),
